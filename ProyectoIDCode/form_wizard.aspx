                        ...
                        <div class="col-lg-7">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div id="wizard">
                                        <%--<h1></h1>  --%>  
                                            <asp:Button ID="Button1" runat="server" Text="Situacion Académica" class="btn btn-primary btn-sm"/>
                                        ...
                                        <asp:Button ID="Button2" runat="server" Text="Devolución de libros" class="btn btn-primary btn-sm"/>
                                        <%--<h1></h1>--%>
                                        <%--<div class="step-content">
                                            <div class="text-center m-t-md">
                                                <h2>Completo</h2>
                                        ...
                                        <asp:Button ID="Button3" runat="server" Text="Estado de deudas" class="btn btn-primary btn-sm"/>
                                        <%--<h1></h1>--%>
                                        <div class="step-content">
                                            <div class="text-center m-t-md">
                                    ...
                                    <table border="0">
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnprevius" runat="server" Text="Previus" class="btn btn-primary btn-lg" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <asp:Button ID="btnnext" runat="server" Text="Next" class="btn btn-primary btn-lg" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <asp:Button ID="btnfinish" runat="server" Text="Finish" class="btn btn-primary btn-lg" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                            <td>
                                                <asp:Button ID="btncancel" runat="server" Text="Cancel" class="btn btn-primary btn-lg" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                        </tr>
                                    </table>
